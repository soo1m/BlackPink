...
ControllerAll = false
local ListSudos ={Sudo_Id,6705059542}  
...
if UserId == 6705059542 then
Status = true
elseif UserId == 6705059542 then
Status = true
...
if tonumber(msg.sender.user_id) == 6705059542 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 6705059542 then
...
{
{text = '𝗦𝗢𝗢𝗠 ⁦', url='https://t.me/R_434'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
download('https://raw.githubusercontent.com/soo1m/BlackPink/main/BlackPink.lua')
...
data = {
{
{text = '‹ رفع المالك والأدمنيه ›', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},{text = '‹ تفعيل الحمايه ›', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},
},
{
...
data = {
{
{text = '- قناة السورس', url = 't.me/R_434'}, 
},
}
}
...
local UserId_Info = LuaTele.searchPublicChat("HHCC6")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/HHCC6"}
},
{
{text = '❲ 𝗦𝗢𝗢𝗠 ❳', url = "https://t.me/R_434"},
},
...
data = {
{
{text = 'Channel Source ،', url = 't.me/R_434'}, 
},
{
{text = 'Annotations Source', url = 't.me/NNN8X'}, 
},
{
{text = 'Developer Source', url = 't.me/Hhcc6'}, 
},
{
{text = 'Developer Source !', url = 't.me/W1e11'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات ســوم بعدين اجاوبك",
...
data = {
{
{text = '᥀ السورس .', url = 't.me/R_434'},{text = '᥀ لتنصيب بوت .', url = 't.me/HHCC6'}, 
},
{
...
data = {
{
{text = '᥀ السورس .', url = 't.me/R_434'},{text = '᥀ لتنصيب بوت .', url = 't.me/w1e11'}, 
},
{
{text = '᥀ اضفني في مجموعتك .', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
